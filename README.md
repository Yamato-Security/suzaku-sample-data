...
The AWS data is gathered from the following sources:
...
The Azure data is gathered from the following sources:
 - [det-eng-samples](https://github.com/blueteam0ps/det-eng-samples): From blueteam0ps's GitHub repository.
 - [o365_dataset](https://github.com/invictus-ir/o365_dataset): From Invictir-ir's GitHub repository.